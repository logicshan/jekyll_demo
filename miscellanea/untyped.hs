...
{-
Weak Head Normal Form: All expressions which are either λ-abstractions or
    of the form
                     ye₁...eₘ
    
    where y is a variable, e₁,...,eₘ are aribitrary expressions and m is
